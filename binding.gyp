{
  "targets": [
    ...
    },
    {
      ...
      "sources": ["dependencies/xms/common/helperfunctions.c", "XmsBridge.cc","utilities.cc","dependencies/xms/common/helperfunctions.c","MessageListener.cpp","ExceptionListener.cpp","MessageReceiver.cpp"],
    ...
    },
    {
      ...
      "sources": ["MessageReceiver.cpp","dependencies/xms/common/helperfunctions.c", "XmsBridgeAsync.cc","utilities.cc","dependencies/xms/common/helperfunctions.c","MessageListener.cpp","ExceptionListener.cpp","MessageReceiver.cpp"],
      "include_dirs": ["dependencies/interfaces","dependencies/xms/lib64","dependencies/xms/cpp/include","dependencies/xms/c/include","dependencies/xms/common","<!(node -e \"require('nan')\")"],
      "dependencies": ["utilities"],
      "libraries": ["../gxi.lib","../gxi01vn.lib"]
    }
